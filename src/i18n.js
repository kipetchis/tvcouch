...
const DICT = {
  ...
  "social.openFriends": { fr: "Gérer mes amis", en: "Manage friends", es: "Gestionar amigos" },
  "social.searchPlaceholder": { fr: "Pseudo d'un ami…", en: "A friend's username…", es: "Usuario de un amigo…" },
  "social.noUserFound": { fr: "Aucun utilisateur avec ce pseudo.", en: "No user with that username.", es: "Ningún usuario con ese nombre." },
  "social.addFriend": { fr: "Ajouter", en: "Add", es: "Añadir" },
  "social.accept": { fr: "Accepter", en: "Accept", es: "Aceptar" },
  "social.decline": { fr: "Refuser", en: "Decline", es: "Rechazar" },
  "social.cancel": { fr: "Annuler", en: "Cancel", es: "Cancelar" },
  "social.removeFriend": { fr: "Retirer", en: "Remove", es: "Quitar" },
  "social.incoming": { fr: "DEMANDES REÇUES", en: "INCOMING REQUESTS", es: "SOLICITUDES RECIBIDAS" },
  "social.outgoing": { fr: "DEMANDES ENVOYÉES", en: "SENT REQUESTS", es: "SOLICITUDES ENVIADAS" },
  "social.myFriends": { fr: "MES AMIS", en: "MY FRIENDS", es: "MIS AMIGOS" },
  "social.noFriends": { fr: "Pas encore d'amis. Cherche un pseudo pour commencer !", en: "No friends yet. Search a username to start!", es: "Aún no tienes amigos. ¡Busca un usuario para empezar!" },
  "social.requestSent": { fr: "Demande envoyée ✓", en: "Request sent ✓", es: "Solicitud enviada ✓" },
  "social.requestError": { fr: "Erreur, réessaie.", en: "Error, try again.", es: "Error, inténtalo de nuevo." },
  "social.cantAddSelf": { fr: "Tu ne peux pas t'ajouter toi-même.", en: "You can't add yourself.", es: "No puedes añadirte a ti mismo." },
  "social.alreadyFriends": { fr: "Vous êtes déjà amis.", en: "You're already friends.", es: "Ya sois amigos." },
  "social.alreadyPending": { fr: "Demande déjà en attente.", en: "Request already pending.", es: "Solicitud ya pendiente." },
  "social.friendLabel": { fr: "Ami", en: "Friend", es: "Amigo" },
  "social.pendingLabel": { fr: "En attente", en: "Pending", es: "Pendiente" },
  ...
  "books.searchBook": { fr: "Rechercher un livre…", en: "Search a book…", es: "Buscar un libro…" },
  "scan.button": { fr: "Scanner un code-barres", en: "Scan a barcode", es: "Escanear un código de barras" },
  "scan.hint": { fr: "Vise le code-barres au dos du livre", en: "Aim at the barcode on the back of the book", es: "Apunta al código de barras en la contraportada" },
  "scan.resolving": { fr: "Recherche du livre…", en: "Looking up the book…", es: "Buscando el libro…" },
  "scan.notFound": { fr: "Ce livre n'a pas été trouvé.", en: "This book wasn't found.", es: "No se encontró este libro." },
  "scan.cameraError": { fr: "Impossible d'accéder à la caméra.", en: "Couldn't access the camera.", es: "No se pudo acceder a la cámara." },
  "scan.retry": { fr: "Réessayer", en: "Try again", es: "Reintentar" },
  "scan.manualLabel": { fr: "Ou saisir le code ISBN à la main :", en: "Or enter the ISBN manually:", es: "O introduce el ISBN manualmente:" },
  "scan.manualValidate": { fr: "Valider", en: "Confirm", es: "Validar" },
  "scan.invalidIsbn": { fr: "Code ISBN invalide (13 chiffres commençant par 978 ou 979).", en: "Invalid ISBN (13 digits starting with 978 or 979).", es: "ISBN no válido (13 dígitos que empiezan por 978 o 979)." },
  "books.read": { fr: "Lus", en: "Read", es: "Leídos" },
  "books.toRead": { fr: "À lire", en: "To read", es: "Por leer" },
  "books.tabRomans": { fr: "Romans", en: "Novels", es: "Novelas" },
  "books.tabManga": { fr: "Mangas & BD", en: "Manga & Comics", es: "Manga y cómics" },
  "manga.searchVolume": { fr: "Rechercher un tome…", en: "Search a volume…", es: "Buscar un tomo…" },
  "manga.seriesName": { fr: "Nom de la série", en: "Series name", es: "Nombre de la serie" },
  "manga.volumeNumber": { fr: "N° de tome", en: "Volume number", es: "N.º de tomo" },
  "manga.volumeNumberPlaceholder": { fr: "ex. 1", en: "e.g. 1", es: "ej. 1" },
  "manga.volumesRead": { fr: "tomes lus", en: "volumes read", es: "tomos leídos" },
  "manga.none": { fr: "Aucune série. Cherchez un tome à ajouter !", en: "No series yet. Search for a volume to add!", es: "Ninguna serie todavía. ¡Busca un tomo para añadir!" },
  "manga.noVolumesYet": { fr: "Aucun tome ajouté à cette série.", en: "No volumes added to this series yet.", es: "Ningún tomo añadido a esta serie." },
  "manga.sectionInProgress": { fr: "En cours", en: "In progress", es: "En curso" },
  "manga.sectionUpToDate": { fr: "À jour", en: "Up to date", es: "Al día" },
  "manga.sectionNotStarted": { fr: "Pas commencées", en: "Not started", es: "Sin empezar" },
  "manga.removeVolume": { fr: "Retirer ce tome", en: "Remove this volume", es: "Quitar este tomo" },
  "books.noneRead": { fr: "Aucun livre lu. Cherchez-en un !", en: "No books read. Search for one!", es: "Sin libros leídos. ¡Busca uno!" },
  "books.noneToRead": { fr: "Aucun livre dans votre liste à lire.", en: "No books in your to-read list.", es: "No hay libros en tu lista." },
  "books.noneFilter": { fr: "Aucun livre ne correspond à ce filtre.", en: "No book matches this filter.", es: "Ningún libro coincide con el filtro." },
  "books.filterTitle": { fr: "Filtrer par titre…", en: "Filter by title…", es: "Filtrar por título…" },
  "books.allGenres": { fr: "Tous les genres", en: "All genres", es: "Todos los géneros" },
  "bookGenre.fantasy": { fr: "Fantasy", en: "Fantasy", es: "Fantasía" },
  "bookGenre.scifi": { fr: "Science-fiction", en: "Sci-Fi", es: "Ciencia ficción" },
  "bookGenre.policier": { fr: "Policier / Thriller", en: "Crime / Thriller", es: "Policíaca / Thriller" },
  "bookGenre.horreur": { fr: "Horreur", en: "Horror", es: "Terror" },
  "bookGenre.romance": { fr: "Romance", en: "Romance", es: "Romance" },
  "bookGenre.aventure": { fr: "Aventure", en: "Adventure", es: "Aventura" },
  "bookGenre.historique": { fr: "Historique", en: "Historical", es: "Histórico" },
  "bookGenre.manga": { fr: "Manga", en: "Manga", es: "Manga" },
  "bookGenre.bd": { fr: "BD / Comics", en: "Comics", es: "Cómic" },
  "bookGenre.jeunesse": { fr: "Jeunesse", en: "Children / YA", es: "Infantil / Juvenil" },
  "bookGenre.biographie": { fr: "Biographie", en: "Biography", es: "Biografía" },
  "bookGenre.humour": { fr: "Humour", en: "Humor", es: "Humor" },
  "bookGenre.essai": { fr: "Essai", en: "Essay", es: "Ensayo" },
  "bookGenre.classique": { fr: "Classique", en: "Classic", es: "Clásico" },
  "books.controlsMenu": { fr: "Options d'affichage", en: "Display options", es: "Opciones de visualización" },
  "book.by": { fr: "de", en: "by", es: "de" },
  "book.readOn": { fr: "Lu le", en: "Read on", es: "Leído el" },
  "reread.readOnce": { fr: "Lu 1 fois", en: "Read once", es: "Leído 1 vez" },
  "reread.read": { fr: "Lu", en: "Read", es: "Leído" },
  "reread.again": { fr: "relu", en: "reread", es: "releído" },
  "game.searchGame": { fr: "Rechercher un jeu…", en: "Search a game…", es: "Buscar un juego…" },
  "game.done": { fr: "Fait", en: "Done", es: "Hecho" },
  "game.todo": { fr: "À faire", en: "To do", es: "Por jugar" },
  "game.doneOn": { fr: "Fini le", en: "Finished on", es: "Terminado el" },
  "game.rateMarksDone": { fr: "Noter marque le jeu comme fait.", en: "Rating marks the game as done.", es: "Puntuar marca el juego como hecho." },
  "game.filterName": { fr: "Filtrer par nom…", en: "Filter by name…", es: "Filtrar por nombre…" },
  "game.allGenres": { fr: "Tous les genres", en: "All genres", es: "Todos los géneros" },
  "game.noneDone": { fr: "Aucun jeu terminé pour l'instant.", en: "No finished games yet.", es: "Aún no hay juegos terminados." },
  "game.noneTodo": { fr: "Aucun jeu dans la liste à faire.", en: "No games in your to-do list.", es: "No hay juegos por jugar." },
  "game.noneFilter": { fr: "Aucun jeu ne correspond au filtre.", en: "No game matches the filter.", es: "Ningún juego coincide con el filtro." },
  "game.rawgCredit": { fr: "Données de jeux fournies par RAWG", en: "Game data provided by RAWG", es: "Datos de juegos proporcionados por RAWG" },
  "replay.doneOnce": { fr: "Fait 1 fois", en: "Done once", es: "Hecho 1 vez" },
  "replay.done": { fr: "Fait", en: "Done", es: "Hecho" },
  "replay.again": { fr: "refait", en: "replayed", es: "rejugado" },
  "gameGenre.action": { fr: "Action", en: "Action", es: "Acción" },
  "gameGenre.adventure": { fr: "Aventure", en: "Adventure", es: "Aventura" },
  "gameGenre.rpg": { fr: "RPG / JDR", en: "RPG", es: "RPG" },
  "gameGenre.shooter": { fr: "Tir / FPS", en: "Shooter", es: "Disparos" },
  "gameGenre.platformer": { fr: "Plateforme", en: "Platformer", es: "Plataformas" },
  "gameGenre.strategy": { fr: "Stratégie", en: "Strategy", es: "Estrategia" },
  "gameGenre.puzzle": { fr: "Réflexion", en: "Puzzle", es: "Puzzle" },
  "gameGenre.racing": { fr: "Course", en: "Racing", es: "Carreras" },
  "gameGenre.sports": { fr: "Sport", en: "Sports", es: "Deportes" },
  "gameGenre.fighting": { fr: "Combat", en: "Fighting", es: "Lucha" },
  "gameGenre.simulation": { fr: "Simulation / Gestion", en: "Simulation", es: "Simulación" },
  "gameGenre.indie": { fr: "Indépendant", en: "Indie", es: "Indie" },
  "gameGenre.arcade": { fr: "Arcade", en: "Arcade", es: "Arcade" },
  "gameGenre.family": { fr: "Familial", en: "Family", es: "Familiar" },
  "gameGenre.horror": { fr: "Horreur", en: "Horror", es: "Terror" },
  "book.recommendations": { fr: "Ce qui pourrait vous plaire", en: "You might also like", es: "Podría gustarte" },
  "books.stats": { fr: "Statistiques", en: "Statistics", es: "Estadísticas" },
  "stats.title": { fr: "Mes statistiques de lecture", en: "My reading stats", es: "Mis estadísticas de lectura" },
  "stats.detailedTitle": { fr: "Statistiques détaillées", en: "Detailed statistics", es: "Estadísticas detalladas" },
  "stats.seeDetailed": { fr: "Voir les statistiques détaillées", en: "See detailed statistics", es: "Ver estadísticas detalladas" },
  "stats.screenSection": { fr: "SÉRIES & FILMS", en: "SHOWS & MOVIES", es: "SERIES Y PELÍCULAS" },
  "stats.topGenresScreen": { fr: "Genres préférés", en: "Favorite genres", es: "Géneros favoritos" },
  "stats.topSeries": { fr: "Séries les plus regardées", en: "Most-watched series", es: "Series más vistas" },
  "stats.decades": { fr: "Décennies des œuvres vues", en: "Decades watched", es: "Décadas vistas" },
  "stats.episodesWatched": { fr: "Épisodes vus", en: "Episodes watched", es: "Episodios vistos" },
  "stats.moviesWatched": { fr: "Films vus", en: "Movies watched", es: "Películas vistas" },
  "stats.totalRead": { fr: "Livres lus", en: "Books read", es: "Libros leídos" },
  "stats.novelsRead": { fr: "Romans lus", en: "Novels read", es: "Novelas leídas" },
  "stats.volumesRead": { fr: "Tomes lus", en: "Volumes read", es: "Tomos leídos" },
  "stats.mangaSeries": { fr: "Séries commencées", en: "Series started", es: "Series empezadas" },
  "stats.topAuthors": { fr: "Auteurs les plus lus", en: "Most-read authors", es: "Autores más leídos" },
  "stats.topGenres": { fr: "Genres les plus lus", en: "Most-read genres", es: "Géneros más leídos" },
  "stats.byYear": { fr: "Lectures par année", en: "Reads by year", es: "Lecturas por año" },
  "stats.gamesSection": { fr: "JEUX VIDÉO", en: "VIDEO GAMES", es: "VIDEOJUEGOS" },
  "stats.gamesDone": { fr: "Jeux finis", en: "Games done", es: "Juegos terminados" },
  "stats.gamesTodo": { fr: "À faire", en: "To do", es: "Por jugar" },
  "stats.gamesReplays": { fr: "Fois refait", en: "Replays", es: "Rejugados" },
  "stats.gamesStudios": { fr: "Studios", en: "Studios", es: "Estudios" },
  "stats.gamesTopGenres": { fr: "Genres préférés", en: "Favorite genres", es: "Géneros favoritos" },
  "stats.gamesTopStudios": { fr: "Studios les plus joués", en: "Most-played studios", es: "Estudios más jugados" },
  "stats.gamesByYear": { fr: "Jeux finis par année", en: "Games finished by year", es: "Juegos terminados por año" },
  "stats.empty": { fr: "Aucune lecture pour l'instant. Marquez des livres comme lus pour voir vos statistiques.", en: "No reads yet. Mark books as read to see your stats.", es: "Sin lecturas todavía. Marca libros como leídos para ver tus estadísticas." },
  "book.rateMarksRead": { fr: "Noter ce livre le marque comme lu.", en: "Rating this book marks it as read.", es: "Calificar este libro lo marca como leído." },
  ...
  "filter.button": { fr: "Filtres", en: "Filters", es: "Filtros" },
  "filter.status": { fr: "Statut", en: "Status", es: "Estado" },
  "filter.genre": { fr: "Genre", en: "Genre", es: "Género" },
  "filter.allGenres": { fr: "Tous les genres", en: "All genres", es: "Todos los géneros" },
  "genre.action": { fr: "Action", en: "Action", es: "Acción" },
  "genre.adventure": { fr: "Aventure", en: "Adventure", es: "Aventura" },
  "genre.animation": { fr: "Animation", en: "Animation", es: "Animación" },
  "genre.comedy": { fr: "Comédie", en: "Comedy", es: "Comedia" },
  "genre.crime": { fr: "Crime", en: "Crime", es: "Crimen" },
  "genre.documentary": { fr: "Documentaire", en: "Documentary", es: "Documental" },
  "genre.drama": { fr: "Drame", en: "Drama", es: "Drama" },
  "genre.family": { fr: "Famille", en: "Family", es: "Familia" },
  "genre.fantasy": { fr: "Fantastique", en: "Fantasy", es: "Fantasía" },
  "genre.history": { fr: "Histoire", en: "History", es: "Historia" },
  "genre.horror": { fr: "Horreur", en: "Horror", es: "Terror" },
  "genre.music": { fr: "Musique", en: "Music", es: "Música" },
  "genre.mystery": { fr: "Mystère", en: "Mystery", es: "Misterio" },
  "genre.romance": { fr: "Romance", en: "Romance", es: "Romance" },
  "genre.scifi": { fr: "Science-fiction", en: "Science Fiction", es: "Ciencia ficción" },
  "genre.tvMovie": { fr: "Téléfilm", en: "TV Movie", es: "Película de TV" },
  "genre.thriller": { fr: "Thriller", en: "Thriller", es: "Suspenso" },
  "genre.war": { fr: "Guerre", en: "War", es: "Guerra" },
  "genre.western": { fr: "Western", en: "Western", es: "Western" },
  "genre.actionAdventure": { fr: "Action & Aventure", en: "Action & Adventure", es: "Acción y aventura" },
  "genre.kids": { fr: "Jeunesse", en: "Kids", es: "Infantil" },
  "genre.news": { fr: "Actualités", en: "News", es: "Noticias" },
  "genre.reality": { fr: "Télé-réalité", en: "Reality", es: "Telerrealidad" },
  "genre.scifiFantasy": { fr: "Science-fiction & Fantastique", en: "Sci-Fi & Fantasy", es: "Ciencia ficción y fantasía" },
  "genre.soap": { fr: "Feuilleton", en: "Soap", es: "Telenovela" },
  "genre.talk": { fr: "Talk-show", en: "Talk", es: "Programa de entrevistas" },
  "genre.warPolitics": { fr: "Guerre & Politique", en: "War & Politics", es: "Guerra y política" },
  ...
  "import.trakt": { fr: "Importer depuis Trakt", en: "Import from Trakt", es: "Importar desde Trakt" },
  "import.traktHelp": {
    fr: "Exporte tes données Trakt (Réglages → Données → « Exporter maintenant »), puis sélectionne directement le fichier .zip téléchargé ci-dessous — pas besoin de le dézipper. Films et séries vus, notes et listes à voir sont importés en une fois.",
    en: "Export your Trakt data (Settings → Data → « Export now »), then select the downloaded .zip file directly below — no need to unzip it. Watched movies and shows, ratings, and watchlists are imported all at once.",
    es: "Exporta tus datos de Trakt (Ajustes → Datos → « Exportar ahora »), luego selecciona directamente el archivo .zip descargado abajo — no hace falta descomprimirlo. Películas y series vistas, notas y listas se importan de una vez.",
  },
  "import.chooseZip": { fr: "Choisir le fichier .zip", en: "Choose the .zip file", es: "Elegir el archivo .zip" },
  "import.traktNotFound": { fr: "élément(s) non importé(s)", en: "item(s) not imported", es: "elemento(s) no importado(s)" },
  ...
  "profile.importTrakt": { fr: "Importer depuis Trakt (zip)", en: "Import from Trakt (zip)", es: "Importar desde Trakt (zip)" },
  "profile.appearance": { fr: "APPARENCE", en: "APPEARANCE", es: "APARIENCIA" },
  "profile.dark": { fr: "Sombre", en: "Dark", es: "Oscuro" },
  "profile.light": { fr: "Clair", en: "Light", es: "Claro" },
  ...
  "profile.gameTrophies": { fr: "TROPHÉES JEUX", en: "GAME TROPHIES", es: "TROFEOS DE JUEGOS" },
  ...
  "trophy.firstrun.name": { fr: "Premier run", en: "First Run", es: "Primera partida" },
  "trophy.firstrun.phrase": { fr: "Le premier jeu d'une longue série.", en: "The first game of a long list.", es: "El primer juego de una larga lista." },
  "trophy.gamer.name": { fr: "Gamer", en: "Gamer", es: "Gamer" },
  "trophy.gamer.phrase": { fr: "La manette ne refroidit jamais.", en: "The controller never cools down.", es: "El mando nunca se enfría." },
  "trophy.hardcore.name": { fr: "Hardcore Gamer", en: "Hardcore Gamer", es: "Jugador hardcore" },
  "trophy.hardcore.phrase": { fr: "Le jeu vidéo est un mode de vie.", en: "Gaming is a way of life.", es: "Jugar es un estilo de vida." },
  "trophy.completionniste.name": { fr: "Complétionniste", en: "Completionist", es: "Completista" },
  "trophy.completionniste.phrase": { fr: "Une fois ne suffit jamais.", en: "Once is never enough.", es: "Una vez nunca es suficiente." },
  "trophy.explorateurstudios.name": { fr: "Explorateur de studios", en: "Studio Explorer", es: "Explorador de estudios" },
  "trophy.explorateurstudios.phrase": { fr: "Chaque studio a sa signature.", en: "Every studio has its signature.", es: "Cada estudio tiene su firma." },
  "trophy.polyvalent.name": { fr: "Polyvalent", en: "All-Rounder", es: "Polivalente" },
  "trophy.polyvalent.phrase": { fr: "Tous les genres y passent.", en: "Every genre gets a turn.", es: "Todos los géneros pasan por aquí." },
  "trophy.critiquejv.name": { fr: "Critique de jeux", en: "Game Critic", es: "Crítico de juegos" },
  "trophy.critiquejv.phrase": { fr: "Chaque jeu mérite ton avis.", en: "Every game deserves your take.", es: "Cada juego merece tu opinión." },
  "trophy.backlog.name": { fr: "Backlog dompté", en: "Backlog Tamed", es: "Backlog domado" },
  "trophy.backlog.phrase": { fr: "La pile de jeux recule enfin.", en: "The pile of games finally shrinks.", es: "El montón de juegos por fin baja." },
};
